...
export default function AppHeader({
  ...
  // Conditionally hook into profile only if we need it (so we don't crash screens outside the provider if any, though it's at root)
  // Actually, let's just use it safely.
  let avatarUri = 'https://i.pravatar.cc/150?img=11';
  try {
...
const styles = StyleSheet.create({
  container: {
    ...
    paddingBottom: 40, // Extra padding to be overlapped by scrollview
  },
  content: {
    flexDirection: 'row',
